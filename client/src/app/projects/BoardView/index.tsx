...
import { useGetTasksQuery, useUpdateTasksStatusMutation } from "../../state/api.ts"
import { Task as TaskType } from "../../state/api.ts";
...
const TaskColumn = ({
  ...
  return (
    <div ref={(instance) => {
      drop(instance)
    }} className={`sm:py-4 rounded-lg py-2 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neural-950" : ""}`}>
      <div className='mb-3 flex w-ful'>
